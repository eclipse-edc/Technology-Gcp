...
public interface BigQuerySourceService {
     ...
     * @param destinationTable the table used to store data retrieved.
     * @param sinkAddress the target address for the sink.
     *
     * @return the stream of DataSource.Part objects.
     */
    Stream<DataSource.Part> runSourceQuery(String query, String destinationTable, DataAddress sinkAddress) throws InterruptedException;
}
